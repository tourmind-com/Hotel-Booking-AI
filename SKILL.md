...
If `search_hotels` did not return `web_url`, omit the entire `👉 More hotels` paragraph. Never ask the user for `user_key` merely to populate this optional link. In Chinese, use this exact wording:
